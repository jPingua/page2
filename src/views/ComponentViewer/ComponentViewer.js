            ...
            <Card>
                ...
                <CardContent>
                    <Grid container direction={'row'}
                        ...
                        <Grid item xs>
                            <Button size={'small'} backgroundColor={'#ff6161'} borderRadius={5}>Small Rounded</Button>
                        </Grid>
                        <Grid item xs>
                            <Button size={'medium'}>Medium </Button>
                        </Grid>
                        <Grid item xs>
                            <Button size={'medium'} backgroundColor={'#ff6161'} borderRadius={5}>Medium Rounded</Button>
                        </Grid>
                        <Grid item xs>
                            <Button size={'large'}>Large </Button>
                        </Grid>
                        <Grid item xs>
                            <Button size={'large'} backgroundColor={'#ff6161'} borderRadius={5}>Large Rounded</Button>
                        </Grid>
                    </Grid>
                </CardContent>
            </Card>
